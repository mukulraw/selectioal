...
public class ScholTestFrag extends Fragment {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (last) {
                    ...
                    Call<questionBean> call = cr.submitScholAnswer(SharePreferenceUtils.getInstance().getString(Constant.USER_id) , qid , pos);
    ...
    void loadData()
    {
        ...
        Call<scholQuesDataBean> call = cr.getScholQuesData(SharePreferenceUtils.getInstance().getString(Constant.USER_id) , qid);

        call.enqueue(new Callback<scholQuesDataBean>() {
            @Override
            public void onResponse(Call<scholQuesDataBean> call, Response<scholQuesDataBean> response) {

                tid = response.body().getData().getScholarId();
                uurl = Constant.BASE_URL + "admin/upload/scholar_ques/" + tid + "/";
            ...
            @Override
            public void onFailure(Call<scholQuesDataBean> call, Throwable t) {
                progress.setVisibility(View.GONE);
            }
        });
